...
if(instance_exists(obj_tural)){
draw_text(50,190,"Thing timer" + string(obj_tural.thing_song_timer));
draw_text(50,210, "Battery Timer" + string(obj_tural.battery_song_timer));
draw_text (50,230, "Textbox destruction: "+ string(obj_tural.textbox_destruction))
}
